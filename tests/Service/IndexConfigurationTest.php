...
class IndexConfigurationTest extends SapphireTest
{
    ...
    public function testGetBatchSizeForClass(): void
    {
        ...
        $this->assertEquals(50, $config->getBatchSizeForClass(Member::class));
        // Should be the batch_size set specifically within index1
        $this->assertEquals(75, $config->getBatchSizeForClass(DataObjectFake::class, 'index1'));
        // Should pick the lowest defined batch_size across all of our indexes
        $this->assertEquals(50, $config->getBatchSizeForClass(DataObjectFake::class));
        // Should not get mixed up with the definitions for DataObjectFake
        $this->assertEquals(25, $config->getBatchSizeForClass(DataObjectSubclassFake::class));
        // Should use the default batch_size of 100
        $this->assertEquals(100, $config->getBatchSizeForClass(Controller::class));
    }
    ...
    public function testGetBatchSizeForClassOnlyIndexes(): void
    {
        ...
        $this->assertEquals(75, $config->getBatchSizeForClass(DataObjectFake::class));
        // Should use batch_size for DataObjectFake, since DataObjectSubclassFake doesn't have an explicit definition
        // in index1
        $this->assertEquals(75, $config->getBatchSizeForClass(DataObjectSubclassFake::class));
